...
var GraphiQL = exports.GraphiQL = function (_React$Component) {
  ...
  _createClass(GraphiQL, [{
    ...
    value: function render() {
      ...
      var numResponses = this.state.responses.length;
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                this.state.responses.map(function (res) {
                  return _react2.default.createElement(_ResultViewer.ResultViewer, {
                    key: res,
                    ref: function ref(c) {
    ...
    value: function _ensureOfSchema() {
      ...
      fetch.then(function (result) {
        ...
        if (result && result.data) {
          ...
          _this4.setState({ responses: [responseString] });
        }
      }).catch(function (error) {
        _this4.setState({ responses: [error && String(error.stack || error)] });
      });
    }
  }, {
    key: '_storageGet',
    ...
    value: function _fetchQuery(query, variables, operationName, cb) {
      ...
      if (isPromise(fetch)) {
        ...
        var subscription = fetch.subscribe(function (res) {
          cb(res, true);
        }, function (error) {
          _this5.setState({
            isWaitingForResponse: false,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleRunQuery = function (selectedOperationName) {
    ...
    try {
      ...
      var subscription = _this6._fetchQuery(editedQuery, variables, operationName, function (result, isSubscription) {
        if (queryID === _this6._editorQueryID) {
          var responses = void 0;
          var response = JSON.stringify(result, null, 2);

          if (isSubscription) {
            responses = _this6.state.responses.concat(response);
          } else {
            responses = [response];
          }
          _this6.setState({
